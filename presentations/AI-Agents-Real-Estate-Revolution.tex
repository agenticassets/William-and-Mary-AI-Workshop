...
\input{../Agentic Assets Private/Overleaf LaTeX Presentations/Template/preamble}
...
\setbeamertemplate{footline}{
    ...
    \hbox{%
        ...
        \begin{beamercolorbox}[wd=.33\paperwidth,ht=2.25ex,dp=1ex,right]{page number in head/foot}%
            \usebeamerfont{page number in head/foot}William \& Mary, 2026 \hfill \insertframenumber{} / \inserttotalframenumber\hspace*{2ex}
        \end{beamercolorbox}%
    }%
    \vskip0pt%
}
...
\logo{\includegraphics[height=.8cm]{../Agentic Assets Private/Overleaf LaTeX Presentations/Images/Stacked TU blue and gold (1).png}}

\author{Dr. Cayman Seagraves, Agentic Assets}
\date{William \& Mary Executive Education Program}
...
\small
  \begin{columns}[onlytextwidth]
    ...
    \column{0.46\textwidth}
      \centering
      \includegraphics[height=0.45\textheight,keepaspectratio]{../Agentic Assets Private/Overleaf LaTeX Presentations/Figures/AI in Real Estate.png}
  \end{columns}
...
\begin{frame}{The Opportunity}
  \begin{columns}[onlytextwidth]
    ...
    \column{0.46\textwidth}
      \centering
      \includegraphics[height=0.5\textheight,keepaspectratio]{../Agentic Assets Private/Overleaf LaTeX Presentations/Figures/ChatGPT Launched - time to 100 M users.png}
  \end{columns}
\end{frame}
